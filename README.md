...
<table><tr>
    ...
    <td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6841&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/powerline-gitstatus-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `powerline-gitstatus` can be installed with:

```
conda install powerline-gitstatus
```

It is possible to list all of the versions of `powerline-gitstatus` available on your platform with:
